...
import { Users, UserPlus, Video, Search, Circle, Star, Crown, MessageCircle, Send } from 'lucide-react';

const EnhancedContactsView = () => {
  ...
  const handleSendInvite = (friendId) => {
    ...
    // Reset after 3 seconds to show invite was sent
    setTimeout(() => {
        ...
        <div>
          ...
          <div className="space-y-4">
            {onlineFriends.map((friend) => {
              const inviteSent = inviteSentTo.has(friend.id);
                ...
                <Card key={friend.id} className="p-6 bg-gray-900/30 border-gray-800/50 hover:bg-gray-900/50 transition-all duration-300 transform hover:scale-[1.02] backdrop-blur-sm rounded-xl">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <Button 
                        size="sm" 
                        className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 hover:scale-105"
                      >
...
export default EnhancedContactsView;
